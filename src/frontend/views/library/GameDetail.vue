...
const fetchGameInfo = (id: String | Number) => {
  const gameData: Record<string, any> = {
    ...
    2: {
      ...
      description:
        'An action RPG rooted in Chinese mythology, featuring the Monkey King and other characters from Journey to the West.',
      size: '45.8 GiB',
...
onMounted(() => {
  gameInfo.value = fetchGameInfo(2)
})
</script>
  ...
  <div class="flex w-full h-full relative">
    ...
    <div class="min-w-[1600px] h-4/5 m-auto flex gap-2">
        ...
        <Card class="h-full p-0 gap-2 border-0 bg-[#1a1b1e] relative">
          ...
          <div class="absolute w-full top-3/5 -translate-y-1/2 z-10">
            ...
            <div class="px-12 pt-2">
              ...
              <div class="mb-2">
                <span class="bg-[#303136] text-sm text-gray-300 px-2 py-1 rounded"
                  >{{ gameInfo.genre }}
                </span>
              </div>
              ...
              <div class="mt-4">
                <div v-if="gameInfo.isInstalled">
                  <Button class="w-full bg-[#00b8d4] hover:bg-[#00a0bc] text-black font-medium py-3"
                    >PLAY NOW</Button
                  >
                </div>
                <div v-else>
      ...
      <div class="flex-1 rounded-md p-2">
        <Card class="h-full p-0 bg-white/25 border-0 relative">
          <div class="absolute inset-0 z-5">
          ...
          <Tabs default-value="install" class="w-full z-10">
            ...
            <TabsContent  value="install">
              <div class=" mt-6 px-4 h-full w-full text-white/75">
            ...
            <TabsContent  value="extra">
              <div class="space-y-4 mt-6 px-4 text-white/75">
                ...
                <div class="flex items-start justify-between">
                  ...
                  <span class="text-right">{{
                    gameInfo?.extraInfo?.releaseDate || gameInfo.releaseDate || 'Unknown'
                  }}</span>
                </div>
