...
export const launchGame = makeHandlerCaller('launchGame')
export const getGameStatusList = makeHandlerCaller('getGameStatusList')
export const exitGame = makeListenerCaller('exitGame')
